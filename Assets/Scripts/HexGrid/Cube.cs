...
public class Cube
{
	...
	Vector3[] directions = // zeru's code for neighbors, 0-5
	{
	...
	// Zeru's neighbor code


	public Vector3 NeighborDirection(int direction) // direction 0-5
	{
		return directions[direction];
	}
	public Cube NeighborAdd(Vector3 neighborVec)
	{
		return new Cube(position.x + neighborVec.x, position.y + neighborVec.y, position.z + neighborVec.z);
	}
	public Cube GetNeighborFromDirection(int direction)
	{
		return NeighborAdd(NeighborDirection(direction));
	}
}
